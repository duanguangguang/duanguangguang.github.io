...
Java提供了种类丰富的锁，每种锁因其特性的不同，在适当的场景下能够展现出非常高的效率。本文基于JDK1.8对锁相关源码、使用场景进行举例，介绍主流锁的知识点，以及不同的锁的适用场景。java主流锁目录：

![](LockConcept\lc01.png)
...
![](LockConcept\lc13.png)

通过上图中的源代码对比，我们可以明显的看出公平锁与非公平锁的lock()方法唯一的区别就在于公平锁在获取同步状态时多了一个限制条件：hasQueuedPredecessors()。

![](LockConcept\lc14.png)
...
![](LockConcept\lc16.png)

但如果是非可重入锁的话，此时管理员只允许锁和同一个人的一个水桶绑定。第一个水桶和锁绑定打完水之后并不会释放锁，导致第二个水桶不能和锁绑定也无法打水。当前线程出现死锁，整个等待队列中的所有线程都无法被唤醒。

![](LockConcept\lc17.png)
...
![](LockConcept\lc20.png)

了解了概念之后我们再来看代码，先看写锁的加锁源码：

![](LockConcept\lc21.png)
...
1. 《Java并发编程艺术》
2. [不可不说的Java“锁”事](https://mp.weixin.qq.com/s/E2fOUHOabm10k_EVugX08g)
...
5. [深入理解读写锁：ReadWriteLock源码分析](https://blog.csdn.net/qq_19431333/article/details/70568478)
6.  [Java synchronized原理总结](https://zhuanlan.zhihu.com/p/29866981)
7. [Java CAS 原理剖析](https://juejin.im/post/5a73cbbff265da4e807783f5)
8. [聊聊并发（二）：Java SE1.6中的Synchronized](http://www.infoq.com/cn/articles/java-se-16-synchronized)
